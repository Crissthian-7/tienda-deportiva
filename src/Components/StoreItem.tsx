    ...
    <Card className='h-100'>
      ...
      <Card.Body className='d-flex flex-column'>
        ...
        <div className='mt-auto'>
          {quantity === 0 ? (
            <Button onClick={() => increaseCartQuantity(id)} className='w-100 btn-dark'>
              + Añadir al carrito
            </Button>
          ) : (
            <div
          ...
          flex-column'
            ...
            >
              <div className='d-flex align-items-center justify-content-center' style={{ gap: ".5rem" }}>
                <Button className='btn-outline-dark btn-light' onClick={() => increaseCartQuantity(id)}>
                  +
                </Button>
                <span className='fs-4 text-bold m-1'>{quantity}</span>En el carrito
                <Button className='btn-outline-dark btn-light' onClick={() => decreaseCartQuantity(id)}>
                  -
                </Button>
              </div>
